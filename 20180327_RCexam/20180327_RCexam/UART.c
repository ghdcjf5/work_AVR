...
/*
동기 통신 비동기 통신
동기는 clock이 있는것 비동기는 clock이없고 시간딜레이를 주어서 통신한다.
...
void TX1_char(unsigned char data)	//아스키코드값을 준다/*ransmit a character by USART1 */
{
...
void UART1_Init(unsigned int Baud)  //uart1만 쓸것이다. avr의 흰단자가 uart1이기떄문
//baud는 초기화 매개변수
{
	char i;
